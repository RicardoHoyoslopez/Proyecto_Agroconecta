      ...
      <div className="hidden lg:flex w-[55%] relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-16 text-white">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-6xl font-extrabold leading-none">AGRO</h1>
          ...
          <p className="text-2xl text-green-100 mt-8 max-w-xl leading-relaxed">
            Regístrate y accede a teleconsultas veterinarias inteligentes para
            mejorar la salud animal y la productividad agropecuaria.
          </p>
